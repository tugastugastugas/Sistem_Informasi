    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                @if(Permission::hasAccess($userLevel, 'Dashboard'))
                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    @if(Permission::hasAccess($userLevel, 'pengumuman_umum'))
                        <li class="nav-item">
                            <a class="nav-link " href="{{route ('pengumuman_umum')}}">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <span class="item-name">Pengumuman Umum</span>
                            </a>
                        </li>
                    @endif
                    @if(Permission::hasAccess($userLevel, 'pengumuman_terpilih'))
                        <li class="nav-item">
                            <a class="nav-link " href="{{route ('pengumuman_terpilih')}}">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
               ...
               @if(Permission::hasAccess($userLevel, 'pengaturan'))
                <li class="nav-item">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                        <li class="me-0 me-xl-2">
                            <a class="btn btn-primary btn-sm d-flex gap-2 align-items-center" aria-current="page" href="{{route('logout')}}">
